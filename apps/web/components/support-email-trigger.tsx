          ...
          >
            <div className="modal-header">
              <div>
                ...
                <h3 id="support-email-title" style={{ margin: 0 }}>
                  {text(lang, "Copy our support email", "复制支持邮箱")}
                </h3>
              </div>
            ...
            <div className="support-email-modal-body">
              <p>
                {text(
                  lang,
                  "If you hit any issue with login, plans, APIs, payment, or testing, copy this email address and contact us directly.",
                  "如果你在登录、会员、API、支付或测试时遇到问题，直接复制这个邮箱地址联系我们即可。"
                )}
              </p>
              ...
              <div className="support-email-actions">
                <button type="button" className="btn btn-primary" onClick={onCopyEmail}>
