...
const copyByLang: Record<Lang, Copy> = {
  en: {
    ...
    fallbackDesc: "No usable YouTube key is connected right now, so the page is showing stable preview rows instead of a blank state.",
    ...
    preview: "Preview",
    locked: "Pro required",
    unlockTitle: "Unlock full trend detail",
    unlockSubtitle: "Upgrade to Pro for full video, channel, and topic detail, plus repeatable benchmark research.",
    viewDetails: "View Details",
    upgradeToView: "Upgrade for Full Detail",
    ...
    close: "Close",
    upgradeForFullDetail: "Upgrade to Pro",
    proNote: "Free lets you browse the radar. Pro unlocks full detail panels so you can turn trends into research-ready inputs.",
  ...
  zh: {
    ...
    fallbackDesc: "当前没有接入可用的 YouTube Key，所以页面自动回退到稳定样例，而不是直接显示空白。",
    openGuide: "查看接入教程",
    updatedAt: "更新时间",
    refreshing: "正在刷新实时趋势...",
